 ...
 * </p>
 */
public final class PopSortedMultiWordSuggestOracle extends SuggestOracle {

  /**
   * Suggestion class for {@link MultiWordSuggestOracle}.
   */
  public static class PopSortedMultiWordSuggestion implements Suggestion, IsSerializable {
     ...
     */
    public PopSortedMultiWordSuggestion() {
    }
     ...
     */
    public PopSortedMultiWordSuggestion(String replacementString, String displayString) {
   ...
   */
  public PopSortedMultiWordSuggestOracle() {
    this(" ");
  }
   ...
   */
  public PopSortedMultiWordSuggestOracle(String whitespaceChars) {
  ...
  private List<String> createCandidatesFromSearch(String query, int limit) {
    ...
    if (candidateSet != null) {
      ...
      Collections.sort(candidates, popComp);

...
class PrefixTree extends AbstractCollection<String> {
  ...
  private static class PrefixTreeIterator implements Iterator<String> {
    ...
    private native void addTree(PrefixTree tree, String prefix) /*-{
      var suffixes = [];
      for (suffix in tree.@com.sun.labs.aura.music.wsitm.client.PrefixTree::suffixes) {
        suffixes.push(suffix);
      }

      var frame = {
        suffixNames: suffixes,
        subtrees: tree.@com.sun.labs.aura.music.wsitm.client.PrefixTree::subtrees,
        prefix: prefix,
        index: 0
      };

      var stack = this.@com.sun.labs.aura.music.wsitm.client.PrefixTree$PrefixTreeIterator::stack;
      stack.push(frame);
    }-*/;
    ...
    private native void init() /*-{
      this.@com.sun.labs.aura.music.wsitm.client.PrefixTree$PrefixTreeIterator::stack = [];
    }-*/;
    ...
    private native String nextImpl(boolean peek) /*-{
      var stack = this.@com.sun.labs.aura.music.wsitm.client.PrefixTree$PrefixTreeIterator::stack;
      var safe = @com.sun.labs.aura.music.wsitm.client.PrefixTree::safe(Ljava/lang/String;)
      var unsafe = @com.sun.labs.aura.music.wsitm.client.PrefixTree::unsafe(Ljava/lang/String;)
        ...
        if (frame.index < frame.suffixNames.length) {
          ...
          if (frame.index < frame.suffixNames.length) {
            ...
            for (key in frame.subtrees) {
              ...
              this.@com.sun.labs.aura.music.wsitm.client.PrefixTree$PrefixTreeIterator::addTree(Lcom/sun/labs/aura/music/wsitm/client/PrefixTree;Ljava/lang/String;)(subtree, target);
            }
          }
  ...
  public native boolean add(String s) /*-{
    var suffixes =
        this.@com.sun.labs.aura.music.wsitm.client.PrefixTree::suffixes;
    var subtrees =
        this.@com.sun.labs.aura.music.wsitm.client.PrefixTree::subtrees;
    var prefixLength =
        this.@com.sun.labs.aura.music.wsitm.client.PrefixTree::prefixLength;
    ...
    if (s.length <= prefixLength) {
      var safeKey = @com.sun.labs.aura.music.wsitm.client.PrefixTree::safe(Ljava/lang/String;)(s);
      if (suffixes.hasOwnProperty(safeKey)) {
        return false;
      } else {
        // Each tree keeps a count of how large it and its children are.
        this.@com.sun.labs.aura.music.wsitm.client.PrefixTree::size++;
    ...
    // Add the string to the appropriate PrefixTree.
      ...
      var prefix = @com.sun.labs.aura.music.wsitm.client.PrefixTree::safe(Ljava/lang/String;)(s.slice(0, prefixLength));
      var theTree;

      if (subtrees.hasOwnProperty(prefix)) {
        theTree = subtrees[prefix];
      } else {
        theTree = @com.sun.labs.aura.music.wsitm.client.PrefixTree::createPrefixTree(I)(prefixLength << 1);
        subtrees[prefix] = theTree;
      }

      var slice = s.slice(prefixLength);
      if (theTree.@com.sun.labs.aura.music.wsitm.client.PrefixTree::add(Ljava/lang/String;)(slice)) {
  ...
  public native void clear() /*-{
    this.@com.sun.labs.aura.music.wsitm.client.PrefixTree::size = 0;
    this.@com.sun.labs.aura.music.wsitm.client.PrefixTree::subtrees = {};
    this.@com.sun.labs.aura.music.wsitm.client.PrefixTree::suffixes = {};
  }-*/;
  ...
  protected native void suggestImpl(String search, String prefix,
    ...
    if (search.length > prefix.length + prefixLength) {
      var key = @com.sun.labs.aura.music.wsitm.client.PrefixTree::safe(Ljava/lang/String;)(search.slice(prefix.length, prefix.length + prefixLength));

      // Just pick the correct subtree, if it exists, and call suggestImpl.
      if (subtrees.hasOwnProperty(key)) {
        var subtree = subtrees[key];
        var target = prefix + @com.sun.labs.aura.music.wsitm.client.PrefixTree::unsafe(Ljava/lang/String;)(key);
        subtree.@com.sun.labs.aura.music.wsitm.client.PrefixTree::suggestImpl(Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;I)(search, target, output, limit);
      }
    ...
    // The answer can only exist in this tree's suffixes or subtree keys.
     ...
     for (suffix in suffixes) {
       var target = prefix + @com.sun.labs.aura.music.wsitm.client.PrefixTree::unsafe(Ljava/lang/String;)(suffix);
     ...
     for (var key in subtrees) {
       ...
       if (target.indexOf(search) == 0) {
         ...
         if ((subtree.@com.sun.labs.aura.music.wsitm.client.PrefixTree::size <= limit - output.@java.util.Collection::size()()) ||
             (subtree.@com.sun.labs.aura.music.wsitm.client.PrefixTree::size == 1)) {
           subtree.@com.sun.labs.aura.music.wsitm.client.PrefixTree::dump(Ljava/util/Collection;Ljava/lang/String;)(output, target);

         // Otherwise, include as many answers as we can by truncating the suffix
         } else {

           // Always fully-specify suffixes.
           for (var suffix in subtree.@com.sun.labs.aura.music.wsitm.client.PrefixTree::suffixes) {
             output.@java.util.Collection::add(Ljava/lang/Object;)(target + @com.sun.labs.aura.music.wsitm.client.PrefixTree::unsafe(Ljava/lang/String;)(suffix));
           }

           // Give the keys of the subtree.
           for (var subkey in subtree.@com.sun.labs.aura.music.wsitm.client.PrefixTree::subtrees) {
             output.@java.util.Collection::add(Ljava/lang/Object;)(target + @com.sun.labs.aura.music.wsitm.client.PrefixTree::unsafe(Ljava/lang/String;)(subkey) + "...");
           }
         }
       }
     }

...
public class HelpPopup {
    ...
    private Widget buildSectionTagCloud() {
        ...
        mainHtml += "<p class=\"helpTxt\" align=\"left\">The Explaura offers you transparent recommendations by explaining to you why artists are being recommended. Simply click on any recommended artist's \"why?\" button to see the overlap between its tag cloud and the seed artist's tag cloud.</p>";
